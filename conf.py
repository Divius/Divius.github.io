...
BLOG_AUTHOR = "Dmitry Tantsur"  # (translatable)
BLOG_TITLE = "Coding Music"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://dtantsur.github.io"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "http://dtantsur.github.io/"
BLOG_EMAIL = "divius.inside@gmail.com"
BLOG_DESCRIPTION = "Coding Music. Site by DAZE aka Dmitry Tantsur."  # (translatable)
...
# Default is:
FILES_FOLDERS = {'talks': 'talks', 'temp': 'temp'}
